...
URL_SECOND_PATH = "/top-billboard-200-albums/"
END_YEAR = 2023
START_YEAR = 2002
FILE_DIR = Path("./billboard_top-billboard-200-albums/data/")
...
def scrape_chart_for_the_year(url):
    ...
    for song in songs:
        ...
        album_name = song_detail.select_one("h3#title-of-a-story").text.strip()
        artist = song_detail.select_one("span").text.strip()
        data.append([artist, album_name])
    return data
